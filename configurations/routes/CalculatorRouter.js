...
module.exports.routePath = function() {
    ...
    router.post('/api/v1/calculator/saveFactfind', configurationHolder.security.authority(Constants.ROUTE_ACCESS_ROLE.CLIENT), CalculatorController.saveFactfindData);
    router.post('/api/v1/calculator/factfind', configurationHolder.security.authority(Constants.ROUTE_ACCESS_ROLE.CLIENT), CalculatorController.getFactfindData);

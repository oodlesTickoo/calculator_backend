    ...
    this.getResults = function(age, fy, currentSalaryExcludeSuper, beforeTTR,
        ...
        for (i = 400; i <= 1000; i = i + 5) {
            for (ss = 0; ss <= upperSS; ss = ss + 10) {
                ...
                tmLevi = TaxRateCalculator.getTaxRate(taxableIncome) * (taxableIncome + 1 - TaxRateCalculator.getLowerBoundValue(taxableIncome)) + TaxRateCalculator.getTaxBase(taxableIncome);
